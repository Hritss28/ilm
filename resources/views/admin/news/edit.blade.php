    ...
    <form method="POST" action="{{ route('admin.news.update', $news) }}" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div class="mb-4">
                ...
                <textarea name="content" id="content" rows="15" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 tinymce-editor">{{ old('content', $news->content) }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-xs text-gray-500">Format: JPEG, PNG, WebP. Maksimal 2MB. Kosongkan jika tidak ingin mengubah.</p>
                @error('thumbnail')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-center pt-6">
                    <label class="flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" name="is_breaking_news" value="1" {{ old('is_breaking_news', $news->is_breaking_news) ? 'checked' : '' }}
                            class="rounded border-gray-300 text-red-600 shadow-sm focus:ring-red-500">
