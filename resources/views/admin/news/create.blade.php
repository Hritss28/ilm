...
<div class="max-w-6xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Tambah Postingan</h1>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="18" class="w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 tinymce-editor">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
