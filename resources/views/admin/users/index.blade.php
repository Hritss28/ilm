...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            ...
                            @elseif($user->role === 'redaktur') bg-blue-100 text-blue-800
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                        Belum ada pengguna. <a href="{{ route('admin.users.create') }}" class="text-red-600 hover:underline">Buat pengguna pertama</a>.
                    </td>
                </tr>
                @endforelse
            </tbody>
